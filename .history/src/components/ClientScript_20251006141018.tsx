  ...
  useEffect(() => {
    ...
    buttons.forEach((btn) => {
      btn.addEventListener("mouseenter", function () {
        (this as HTMLElement).style.transform = "translateY(-2px) scale(1.02)";
        (this as HTMLElement).style.boxShadow = "0 10px 25px rgba(37, 99, 235, 0.3)";
      });
      ...
      btn.addEventListener("mousedown", function () {
        (this as HTMLElement).style.transform = "translateY(0) scale(0.98)";
      });
    ...
    projectCards.forEach((card) => {
      card.addEventListener("mousemove", function (e) {
        ...
        (this as HTMLElement).style.transform = `perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.02)`;
      });
    ...
    if (contactForm) {
      ...
      formInputs.forEach((input) => {
        input.addEventListener("focus", function () {
          ...
          (this as HTMLElement).style.borderColor = "var(--primary-color)";
          (this as HTMLElement).style.boxShadow = "0 0 0 3px rgba(37, 99, 235, 0.1)";
        });
