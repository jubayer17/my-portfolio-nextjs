...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      {/* Navigation */}
      <nav className={`navbar ${scrollProgress > 5 ? 'scrolled' : ''}`} id="navbar">
        <div className="nav-container">
          <div className="nav-logo">
            <a href="#home" onClick={(e) => { e.preventDefault(); scrollToSection('home'); }} className="hover-scale magnetic">
              <Image className="img-icon" src="/assets/pc-icon.png" alt="Logo" width={50} height={50} />
            </a>
          </div>
          ...
          <ul className={`nav-menu ${mobileMenuOpen ? 'active' : ''}`} id="nav-menu">
            {[
              ...
              <li key={item.id} className="nav-item">
                <a 
                  href={`#${item.id}`} 
                  className={`nav-link hover-lift ${activeSection === item.id ? 'active' : ''}`}
          ...
          <div 
            className={`nav-toggle hover-scale ${mobileMenuOpen ? 'active' : ''}`} 
            id="mobile-menu"
      ...
      <section id="home" className="hero">
        ...
        <div className="tech-bg-animation">
          ...
          <div className="code-particles">
            {[
              'fab fa-react', 'fab fa-js-square', 'fab fa-node-js', 'fab fa-html5',
              'fab fa-css3-alt', 'fab fa-python', 'fab fa-java', 'fab fa-php',
              'fab fa-angular', 'fab fa-vuejs', 'fab fa-laravel', 'fab fa-bootstrap',
              'fab fa-sass', 'fab fa-less', 'fab fa-git-alt', 'fab fa-github',
              'fab fa-gitlab', 'fab fa-docker', 'fab fa-aws', 'fab fa-google-cloud',
              'fab fa-microsoft'
            ].map((icon, index) => (
          ...
          <div className="floating-icons">
            {[
              'fab fa-js-square', 'fab fa-react', 'fab fa-node-js', 'fas fa-database',
              'fab fa-git-alt', 'fab fa-npm', 'fab fa-html5', 'fab fa-css3-alt',
              'fab fa-python', 'fab fa-docker', 'fab fa-aws', 'fab fa-github'
            ].map((icon, index) => (
              <i key={index} className={`${icon} tech-icon tech-icon-${index + 1}`}></i>
            ))}
          </div>
        </div>
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description animate-text">
              ...
              high-performance web apps ✨ <br />🧠 100+ LeetCode solved 🦾
              <br />⚔️ 500+ Codeforces challenges conquered 🔥
            </p>
            <div className="hero-badge availability-badge pulse-icon hover-glow">
              <i
                className="fas fa-circle"
                style={{ color: '#10b981', fontSize: '0.7rem', marginRight: '10px' }}
              ></i>
          ...
          <div className="about-content animate-on-scroll">
            ...
            <div className="about-text animate-on-scroll-right">
              ...
              <p className="fade-in-up stagger-2">
                🚀 I specialize in Next.js for server-side rendering, API routes,
                and performance optimization. From crafting responsive frontends
                to designing robust backend architectures, I deliver end-to-end
                solutions.
              </p>
              <p className="fade-in-up stagger-3">
                ⚡ When I&apos;m not coding, you&apos;ll find me exploring the latest in web
                development, contributing to open-source projects, or sharing
                knowledge with the developer community over a perfect cup of
                coffee.
              </p>
            ...
            <div className="skill-category animate-on-scroll-left hover-lift magnetic-card">
              ...
              <div className="skill-items">
                {[
                  ...
                  { name: 'JavaScript ES6+', icon: 'fab fa-js-square', class: 'javascript' },
                  { name: 'TypeScript', icon: 'fab fa-js-square', class: 'typescript' },
                  { name: 'HTML5 & CSS3', icon: 'fab fa-html5', class: 'html' },
                  { name: 'Tailwind CSS', icon: 'fab fa-sass', class: 'tailwind' }
                ].map((skill, index) => (
                  <span key={index} className={`skill-item ${skill.class} stagger-child hover-scale`}>
            ...
            <div className="skill-category animate-on-scroll hover-lift magnetic-card">
              ...
              <div className="skill-items">
                {[
                  ...
                  { name: 'Mongoose ODM', icon: 'fas fa-database', class: 'mongoose' },
                  { name: 'Inngest', icon: 'fa-solid fa-screwdriver-wrench', class: 'inngest' },
            ...
            <div className="skill-category animate-on-scroll-right hover-lift magnetic-card">
              ...
              <div className="skill-items">
                {[
                  ...
                  { name: 'Vercel', icon: 'fa-solid fa-server', class: 'vercel' },
          ...
          <div className="projects-grid">
            <div className="project-card animate-on-scroll-left hover-lift magnetic-card">
              <div className="project-image">
                <Image src="/assets/technestSS.png" alt="Tech-Nest Dashboard" width={400} height={180} />
              ...
              <div className="project-content">
                ...
                <p className="project-description">
                  ...
                  built with Next.js, offering seamless browsing, secure payments
                  via Stripe and COD, and robust admin management.
                </p>
            ...
            <div className="project-card animate-on-scroll hover-lift magnetic-card">
              <div className="project-image">
                <Image src="/assets/edulectaSS.png" alt="Edulecta Screenshot" width={400} height={180} />
                <div className="project-overlay">
                  <div className="project-links">
                    <a
              ...
              <div className="project-content">
                ...
                <p className="project-description">
                  Edulecta is an innovative eLearning platform developed with the
                  MERN stack, designed to provide seamless online education with
            ...
            <div className="project-card">
              <div className="project-image">
                <div className="project-overlay">
                  <div className="project-links">
                    ...
                    <a href="#" className="project-link" aria-label="View GitHub">
                      <i className="fab fa-github"></i>
                    </a>
                  </div>
                </div>
              ...
              <div className="project-content">
                ...
                <p className="project-description">
                  A responsive weather forecast app that displays current weather
                  and forecasts for multiple cities with beautiful data
                  visualizations.
                </p>
                <div className="project-tech">
            ...
            <div className="contact-info">
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div>
                    <strong>Email:</strong>
                    <a href="mailto:jubayer17@cse.pstu.ac.bd">jubayer17@cse.pstu.ac.bd</a>
                  </div>
                </div>
                <div className="contact-item">
