  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-3xl">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(167,139,250,0.07) 0%, transparent 70%)", animationDelay: "2s" }}
      />
      <div
        className="glow-blob absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full"
        style={{ background: "radial-gradient(circle, rgba(34,211,238,0.04) 0%, transparent 70%)", animationDelay: "4s" }}
      />
      ...
      >
        ...
        <g stroke="url(#techLineGrad)" strokeWidth="0.4" fill="none">
